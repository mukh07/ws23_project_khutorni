<script lang="ts">
      import {useEdges, type EdgeProps, getBezierPath, BaseEdge, MarkerType} from '@xyflow/svelte';
...
<BaseEdge {path} markerEnd={{ type: MarkerType.ArrowClosed, strokeWidth: 1, width: 10 }} style="stroke-width: 2px;"/>
